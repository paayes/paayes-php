...
// Paayes singleton
require __DIR__ . '/lib/Paayes.php';
...
require __DIR__ . '/lib/PaayesObject.php';
...
// PaayesClient
require __DIR__ . '/lib/BasePaayesClientInterface.php';
require __DIR__ . '/lib/PaayesClientInterface.php';
require __DIR__ . '/lib/PaayesStreamingClientInterface.php';
require __DIR__ . '/lib/BasePaayesClient.php';
require __DIR__ . '/lib/PaayesClient.php';

// Paayes API Resources
