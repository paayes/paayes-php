...
/**
 * A <code>Transfer</code> object is created when you move funds between Paayes
 * accounts as part of Connect.
 *
 * Before April 6, 2017, transfers also represented movement of funds from a Paayes
 * account to a card or bank account. This behavior has since been split out into a
 * <a href="https://docs.paayes.com/docs/api#payout_object">Payout</a> object, with
 * corresponding payout endpoints. For more information, read about the <a
 * href="https://docs.paayes.com/docs/transfer-payout-split">transfer/payout split</a>.
 *
 * Related guide: <a
 * href="https://docs.paayes.com/docs/connect/charges-transfers">Creating Separate
 ...
 * @property null|string|\Paayes\BalanceTransaction $balance_transaction Balance transaction that describes the impact of this transfer on your account balance.
 ...
 * @property null|string|\Paayes\Account $destination ID of the Paayes account the transfer was sent to.
 * @property string|\Paayes\Charge $destination_payment If the destination is a Paayes account, this will be the ID of the payment that the destination account received for the transfer.
 ...
 * @property \Paayes\Collection $reversals A list of reversals that have been applied to the transfer.
 ...
 * @property null|string|\Paayes\Charge $source_transaction ID of the charge or payment that was used to fund the transfer. If null, the transfer was funded from the available balance.
...
class Transfer extends ApiResource
{
     ...
     *
     * @return \Paayes\Transfer the canceled transfer
     */
     ...
     * @throws \Paayes\Exception\ApiErrorException if the request fails
     *
     * @return \Paayes\Collection the list of transfer reversals
     */
     ...
     * @throws \Paayes\Exception\ApiErrorException if the request fails
     *
     * @return \Paayes\TransferReversal
     */
