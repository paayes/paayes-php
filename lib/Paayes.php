...
class Paayes
{
    /** @var string The Paayes API key to be used for requests. */
    public static $apiKey;

    /** @var string The Paayes client_id to be used for Connect requests. */
    public static $clientId;

    /** @var string The base URL for the Paayes API. */
    public static $apiBase = 'https://api.paayes.com';

    /** @var string The base URL for the OAuth API. */
    public static $connectBase = '';

    /** @var string The base URL for the Paayes API uploads endpoint. */
    public static $apiUploadBase = '';

    /** @var null|string The version of the Paayes API to use for requests. */
    ...
    /** @var float Maximum delay between retries, in seconds, that will be respected from the Paayes API */
    ...
    /**
     * @return string | null The Paayes account ID for connected account
     *   requests
     */
    ...
    /**
     * @param string $accountId the Paayes account ID to set for connected
     *   account requests
     */
    ...
    /**
     * @return float Maximum delay between retries, in seconds, that will be respected from the Paayes API
     */
     ...
     *
     * Client telemetry enables timing and request metrics to be sent back to Paayes as an HTTP Header
     * with the current request. This enables Paayes to do latency and metrics analysis without adding extra
