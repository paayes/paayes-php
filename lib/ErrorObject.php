 ...
 * @property PaayesObject $source The source object for errors returned on a
 ...
 */
class ErrorObject extends PaayesObject
{
    /**
     * Possible string representations of an error's code.
     *
     * @see https://docs.paayes.com/docs/error-codes
     */
