 ...
 * @property string|\Paayes\Account $account ID of the Paayes account this fee was taken from.
 ...
 * @property string|\Paayes\PaayesObject $application ID of the Connect application that earned the fee.
 * @property null|string|\Paayes\BalanceTransaction $balance_transaction Balance transaction that describes the impact of this collected application fee on your account balance (not including refunds).
 * @property string|\Paayes\Charge $charge ID of the charge that the application fee was taken from.
 ...
 * @property null|string|\Paayes\Charge $originating_transaction ID of the corresponding charge on the platform account, if this fee was the result of a charge using the <code>destination</code> parameter.
 ...
 * @property \Paayes\Collection $refunds A list of refunds that have been applied to the fee.
 */
class ApplicationFee extends ApiResource
{
     ...
     *
     * @return \Paayes\Collection the list of fee refunds
     */
     ...
     * @throws \Paayes\Exception\ApiErrorException if the request fails
     *
     * @return \Paayes\ApplicationFeeRefund
     */
