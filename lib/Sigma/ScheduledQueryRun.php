...
/**
 * If you have <a href="https://docs.paayes.com/docs/sigma/scheduled-queries">scheduled
 ...
 * @property int $data_load_time When the query was run, Sigma contained a snapshot of your Paayes data at this time.
 * @property \Paayes\PaayesObject $error
 * @property null|\Paayes\File $file The file object representing the results of the query.
 ...
 */
class ScheduledQueryRun extends \Paayes\ApiResource
{
    ...
    {
        return '/api/v1/sigma/scheduled_query_runs';
    }
}
