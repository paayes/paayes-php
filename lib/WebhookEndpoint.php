...
/**
 * You can configure <a href="https://docs.paayes.com/docs/webhooks/">webhook
 * endpoints</a> via the API to be notified about events that happen in your Paayes
 * account or connected accounts.
 *
 * Most users configure webhooks from <a
 * href="https://dashboard.paayes.com/webhooks">the dashboard</a>, which provides a
 * user interface for registering and testing your webhook endpoints.
 *
 * Related guide: <a href="https://docs.paayes.com/docs/webhooks/configure">Setting up
 * Webhooks</a>.
 *
 ...
 * @property string $secret The endpoint's secret, used to generate <a href="https://docs.paayes.com/docs/webhooks/signatures">webhook signatures</a>. Only returned at creation.
