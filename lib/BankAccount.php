 ...
 *
 * On the other hand <a
 * href="https://docs.paayes.com/docs/api#external_accounts">External Accounts</a> are
 * transfer destinations on <code>Account</code> objects for <a
 * href="https://docs.paayes.com/docs/connect/custom-accounts">Custom accounts</a>. They
 * can be bank accounts or debit cards as well, and are documented in the links
 * above.
 *
 * Related guide: <a
 * href="https://docs.paayes.com/docs/payments/bank-debits-transfers">Bank Debits and
 * Transfers</a>.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property null|string|\Paayes\Account $account The ID of the account that the bank account is associated with.
 ...
 * @property string $currency Three-letter <a href="https://docs.paayes.com/docs/payouts">ISO code for the currency</a> paid out to the bank account.
 * @property null|string|\Paayes\Customer $customer The ID of the customer that the bank account is associated with.
...
class BankAccount extends ApiResource
{
     ...
     *
     * @see https://docs.paayes.com/api/external_account_bank_accounts/object#account_bank_account_object-status
     */
