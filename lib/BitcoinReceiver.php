 ...
 * @see https://docs.paayes.com/docs/sources/bitcoin
 *
 ...
 * @property string $currency Three-letter <a href="https://docs.paayes.com/docs/currencies">ISO code for the currency</a> to which the bitcoin will be converted.
 ...
 * @property \Paayes\Collection $transactions A list with one entry for each time that the customer sent bitcoin to the receiver. Hidden when viewing the receiver with a publishable key.
