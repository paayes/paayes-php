 ...
 *
 * Related guide: <a
 * href="https://docs.paayes.com/docs/payments/save-during-payment">Save a card during
 * payment</a>.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property null|\Paayes\PaayesObject $address The customer's address.
 * @property int $balance Current balance, if any, being stored on the customer. If negative, the customer has credit to apply to their next invoice. If positive, the customer has an amount owed that will be added to their next invoice. The balance does not refer to any unpaid invoices; it solely takes into account amounts that have yet to be successfully applied to any invoice. This balance is only taken into account as invoices are finalized.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|string $currency Three-letter <a href="https://docs.paayes.com/docs/currencies">ISO code for the currency</a> the customer can be charged in for recurring billing purposes.
 * @property null|string|\Paayes\Account|\Paayes\AlipayAccount|\Paayes\BankAccount|\Paayes\BitcoinReceiver|\Paayes\Card|\Paayes\Source $default_source <p>ID of the default payment source for the customer.</p><p>If you are using payment methods created via the PaymentMethods API, see the <a href="https://docs.paayes.com/api/customers/object#customer_object-invoice_settings-default_payment_method">invoice_settings.default_payment_method</a> field instead.</p>
 * @property null|bool $delinquent <p>When the customer's latest invoice is billed by charging automatically, <code>delinquent</code> is <code>true</code> if the invoice's latest charge failed. When the customer's latest invoice is billed by sending an invoice, <code>delinquent</code> is <code>true</code> if the invoice isn't paid by its due date.</p><p>If an invoice is marked uncollectible by <a href="https://docs.paayes.com/docs/billing/automatic-collection">dunning</a>, <code>delinquent</code> doesn't get reset to <code>false</code>.</p>
 * @property null|string $description An arbitrary string attached to the object. Often useful for displaying to users.
 * @property null|\Paayes\Discount $discount Describes the current discount active on the customer, if there is one.
 ...
 * @property \Paayes\PaayesObject $invoice_settings
 ...
 * @property null|\Paayes\PaayesObject $shipping Mailing and shipping address for the customer. Appears on invoices emailed to this customer.
 * @property \Paayes\Collection $sources The customer's payment sources, if any.
 * @property \Paayes\Collection $subscriptions The customer's current subscriptions, if any.
 * @property \Paayes\PaayesObject $tax
 ...
 * @property \Paayes\Collection $tax_ids The customer's tax IDs.
 */
class Customer extends ApiResource
{
     ...
     *
     * @return \Paayes\Customer the updated customer
     */
     ...
     *
     * @return \Paayes\Collection the list of customer balance transactions
     */
     ...
     * @throws \Paayes\Exception\ApiErrorException if the request fails
     *
     * @return \Paayes\Collection the list of payment sources (AlipayAccount, BankAccount, BitcoinReceiver, Card or Source)
     */
     ...
     * @throws \Paayes\Exception\ApiErrorException if the request fails
     *
     * @return \Paayes\Collection the list of tax ids
     */
