...
/**
 * This is an object representing a file hosted on Paayes's servers. The file may
 * have been uploaded by yourself using the <a
 * href="https://docs.paayes.com/docs/api#create_file">create file</a> request (for
 * example, when uploading dispute evidence) or it may have been created by Paayes
 * (for example, the results of a <a href="#scheduled_queries">Sigma scheduled
 * query</a>).
 *
 * Related guide: <a href="https://docs.paayes.com/docs/file-upload">File Upload
 * Guide</a>.
 *
 ...
 * @property null|\Paayes\Collection $links A list of <a href="https://docs.paayes.com/docs/api#file_links">file links</a> that point at this file.
 * @property string $purpose The <a href="https://docs.paayes.com/docs/file-upload#uploading-a-file">purpose</a> of the uploaded file.
...
class File extends ApiResource
{
    ...
    // versions, only `file` is used, but since Paayes-php may be used with
