 ...
 *
 * Related guide: <a
 * href="https://docs.paayes.com/docs/billing/invoices/credit-notes">Credit Notes</a>.
 *
 ...
 * @property string|\Paayes\Customer $customer ID of the customer.
 * @property null|string|\Paayes\CustomerBalanceTransaction $customer_balance_transaction Customer balance transaction related to this credit note.
 * @property int $discount_amount The integer amount in %s representing the total amount of discount that was credited.
 * @property \Paayes\PaayesObject[] $discount_amounts The aggregate amounts calculated per discount for all line items.
 * @property string|\Paayes\Invoice $invoice ID of the invoice.
 * @property \Paayes\Collection $lines Line items that make up the credit note
 ...
 * @property null|int $out_of_band_amount Amount that was credited outside of Paayes.
 ...
 * @property null|string|\Paayes\Refund $refund Refund related to this credit note.
 * @property string $status Status of this credit note, one of <code>issued</code> or <code>void</code>. Learn more about <a href="https://docs.paayes.com/docs/billing/invoices/credit-notes#voiding">voiding credit notes</a>.
 ...
 * @property \Paayes\PaayesObject[] $tax_amounts The aggregate amounts calculated per tax rate for all line items.
...
class CreditNote extends ApiResource
{
     ...
     *
     * @return \Paayes\CreditNote the previewed credit note
     */
     ...
     * @throws \Paayes\Exception\ApiErrorException if the request fails
     *
     * @return \Paayes\CreditNote the voided credit note
     */
     ...
     * @throws \Paayes\Exception\ApiErrorException if the request fails
     *
     * @return \Paayes\Collection the list of credit note line items
     */
