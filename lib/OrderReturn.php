 ...
 * href="https://docs.paayes.com/docs/api#order_items">order items</a>. Returns always
 * belong to an order, and may optionally contain a refund.
 *
 * Related guide: <a
 * href="https://docs.paayes.com/docs/orders/guide#handling-returns">Handling
 * Returns</a>.
 *
 ...
 * @property \Paayes\OrderItem[] $items The items included in this order return.
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|string|\Paayes\Order $order The order that this return includes items from.
 * @property null|string|\Paayes\Refund $refund The ID of the refund issued for this return.
 */
