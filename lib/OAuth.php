...
abstract class OAuth
{
    ...
    public static function authorizeUrl($params = null, $opts = null)
    {
        ...
        $base = ($opts && \array_key_exists('connect_base', $opts)) ? $opts['connect_base'] : Paayes::$connectBase;
     ...
     *
     * @return PaayesObject object containing the response from the API
     */
    public static function token($params = null, $opts = null)
    {
        ...
        return Util\Util::convertToPaayesObject($response->json, $opts);
    }
    ...
    private static function _getClientId($params = null)
    {
        ...
        if (null === $clientId) {
            $clientId = Paayes::getClientId();
        }
        if (null === $clientId) {
            $msg = 'No client_id provided.  (HINT: set your client_id using '
                . '"Paayes::setClientId(<CLIENT-ID>)".  You can find your client_ids '
