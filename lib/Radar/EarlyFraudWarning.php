 ...
 *
 * Related guide: <a
 * href="https://docs.paayes.com/docs/disputes/measuring#early-fraud-warnings">Early
 * Fraud Warnings</a>.
 *
 ...
 * @property string|\Paayes\Charge $charge ID of the charge this early fraud warning is for, optionally expanded.
 ...
 * @property string|\Paayes\PaymentIntent $payment_intent ID of the Payment Intent this early fraud warning is for, optionally expanded.
 */
class EarlyFraudWarning extends \Paayes\ApiResource
{
