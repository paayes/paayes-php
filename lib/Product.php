 ...
 * conjunction with <a href="https://docs.paayes.com/docs/api#prices">Prices</a> to
 ...
 * href="https://docs.paayes.com/docs/payments/checkout/client#create-products">one-time
 ...
 * @property null|\Paayes\PaayesObject $package_dimensions The dimensions of this product for shipping purposes.
 ...
 * @property null|string|\Paayes\TaxCode $tax_code A <a href="https://docs.paayes.com/docs/tax/tax-codes">tax code</a> ID.
 ...
 * @property null|string $unit_label A label that represents units of this product in Paayes and on customers’ receipts and invoices. When set, this will be included in associated invoice line item descriptions.
