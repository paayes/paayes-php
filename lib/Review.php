 ...
 * href="https://docs.paayes.com/docs/radar/reviews">here</a>.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property null|string $billing_zip The ZIP or postal code of the card used, if applicable.
 * @property null|string|\Paayes\Charge $charge The charge associated with this review.
 ...
 * @property null|\Paayes\PaayesObject $ip_address_location Information related to the location of the payment. Note that this information is an approximation and attempts to locate the nearest population center - it should not be used to determine a specific address.
 ...
 * @property string|\Paayes\PaymentIntent $payment_intent The PaymentIntent ID associated with this review, if one exists.
 ...
 * @property null|\Paayes\PaayesObject $session Information related to the browsing session of the user who initiated the payment.
 */
class Review extends ApiResource
{
     ...
     *
     * @see https://docs.paayes.com/api/radar/reviews/object
     */
     ...
     *
     * @return \Paayes\Review the approved review
     */
