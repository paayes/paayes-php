...
/**
 * This is an object representing a Paayes account. You can retrieve it to see
 * properties on the account like its current e-mail address or if the account is
 * enabled yet to make live charges.
 *
 * Some properties, marked below, are available only to platforms that want to <a
 * href="https://docs.paayes.com/docs/connect/accounts">create and manage Express or
 * Custom accounts</a>.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property null|\Paayes\PaayesObject $business_profile Business information about the account.
 * @property null|string $business_type The business type.
 * @property \Paayes\PaayesObject $capabilities
 * @property bool $charges_enabled Whether the account can create live charges.
 * @property \Paayes\PaayesObject $company
 * @property \Paayes\PaayesObject $controller
 * @property string $country The account's country.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property string $default_currency Three-letter ISO currency code representing the default currency for the account. This must be a currency that <a href="https://docs.paayes.com/docs/payouts">Paayes supports in the account's country</a>.
 ...
 * @property \Paayes\Collection $external_accounts External accounts (bank accounts and debit cards) currently attached to this account
 * @property \Paayes\PaayesObject $future_requirements
 * @property \Paayes\Person $individual <p>This is an object representing a person associated with a Paayes account.</p><p>A platform cannot access a Standard or Express account's persons after the account starts onboarding, such as after generating an account link for the account. See the <a href="https://docs.paayes.com/docs/connect/standard-accounts">Standard onboarding</a> or <a href="https://docs.paayes.com/docs/connect/express-accounts">Express onboarding documentation</a> for information about platform pre-filling and account onboarding steps.</p><p>Related guide: <a href="https://docs.paayes.com/docs/connect/identity-verification-api#person-information">Handling Identity Verification with the API</a>.</p>
 ...
 * @property bool $payouts_enabled Whether Paayes can send payouts to this account.
 * @property \Paayes\PaayesObject $requirements
 * @property null|\Paayes\PaayesObject $settings Options for customizing how the account functions within Paayes.
 * @property \Paayes\PaayesObject $tos_acceptance
 * @property string $type The Paayes account type. Can be <code>standard</code>, <code>express</code>, or <code>custom</code>.
 */
class Account extends ApiResource
{
    ...
    private function serializeAdditionalOwners($legalEntity, $additionalOwners)
    {
        ...
        foreach ($additionalOwners as $i => $v) {
            $update = ($v instanceof PaayesObject) ? $v->serializeParameters() : $v;
     ...
     * @throws \Paayes\Exception\ApiErrorException if the request fails
     *
     * @return \Paayes\Collection the list of persons
     */
    public function persons($params = null, $opts = null)
    {
        $url = $this->instanceUrl() . '/persons';
        list($response, $opts) = $this->_request('get', $url, $params, $opts);
        $obj = Util\Util::convertToPaayesObject($response, $opts);
     ...
     * @throws \Paayes\Exception\ApiErrorException if the request fails
     *
     * @return \Paayes\Account the rejected account
     */
     ...
     * @throws \Paayes\Exception\ApiErrorException if the request fails
     *
     * @return \Paayes\Collection the list of capabilities
     */
     ...
     * @throws \Paayes\Exception\ApiErrorException if the request fails
     *
     * @return \Paayes\Collection the list of external accounts (BankAccount or Card)
     */
