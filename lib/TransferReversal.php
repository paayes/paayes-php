...
/**
 * <a href="https://docs.paayes.com/docs/connect">Paayes Connect</a> platforms can
 ...
 * href="https://docs.paayes.com/docs/connect/charges-transfers#transfer-options">transfer_group</a>
 * transfer only if the destination account has enough balance to cover the
 * reversal.
 *
 * Related guide: <a
 * href="https://docs.paayes.com/docs/connect/charges-transfers#reversing-transfers">Reversing
 * Transfers</a>.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property int $amount Amount, in %s.
 * @property null|string|\Paayes\BalanceTransaction $balance_transaction Balance transaction that describes the impact on your account balance.
 ...
 * @property null|string|\Paayes\Refund $destination_payment_refund Linked payment refund for the transfer reversal.
 ...
 * @property null|string|\Paayes\Refund $source_refund ID of the refund responsible for the transfer reversal.
 * @property string|\Paayes\Transfer $transfer ID of the transfer that was reversed.
 */
class TransferReversal extends ApiResource
{
    ...
    /**
     * @return string the API URL for this Paayes transfer reversal
     */
