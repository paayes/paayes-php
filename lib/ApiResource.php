 ...
 * Class ApiResource.
 */
abstract class ApiResource extends PaayesObject
{
    use ApiOperations\Request;

    /**
     * @return \Paayes\Util\Set A list of fields that can be their own type of
    ...
    public static function classUrl()
    {
        ...
        // "foo.bar", then its URL will be "/api/v1/foo/bars".
