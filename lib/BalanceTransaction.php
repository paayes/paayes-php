...
/**
 * Balance transactions represent funds moving through your Paayes account. They're
 * created for every type of transaction that comes into or flows out of your
 * Paayes account balance.
 *
 * Related guide: <a
 * href="https://docs.paayes.com/docs/reports/balance-transaction-types">Balance
 * Transaction Types</a>.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property int $amount Gross amount of the transaction, in %s.
 * @property int $available_on The date the transaction's net funds will become available in the Paayes balance.
...
class BalanceTransaction extends ApiResource
{
    ...
    const TYPE_Paayes_FEE = 'Paayes_fee';
    const TYPE_Paayes_FX_FEE = 'Paayes_fx_fee';
