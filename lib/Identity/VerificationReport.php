 ...
 * <a href="https://docs.paayes.com/api/files">FileUpload</a> API. To configure and
 * create VerificationReports, use the <a
 * href="https://docs.paayes.com/api/identity/verification_sessions">VerificationSession</a>
 * API.
 *
 * Related guides: <a
 * href="https://docs.paayes.com/docs/identity/verification-sessions#results">Accessing
 * verification results</a>.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property \Paayes\PaayesObject $document Result from a document check
 * @property \Paayes\PaayesObject $id_number Result from an id_number check
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property \Paayes\PaayesObject $options
 * @property \Paayes\PaayesObject $selfie Result from a selfie check
 ...
 */
class VerificationReport extends \Paayes\ApiResource
{
