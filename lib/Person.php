...
/**
 * This is an object representing a person associated with a Paayes account.
 *
 ...
 * account. See the <a
 * href="https://docs.paayes.com/docs/connect/standard-accounts">Standard onboarding</a>
 * or <a href="https://docs.paayes.com/docs/connect/express-accounts">Express onboarding
 * documentation</a> for information about platform pre-filling and account
 * onboarding steps.
 *
 * Related guide: <a
 * href="https://docs.paayes.com/docs/connect/identity-verification-api#person-information">Handling
 ...
 * @property null|\Paayes\PaayesObject $address_kana The Kana variation of the person's address (Japan only).
 * @property null|\Paayes\PaayesObject $address_kanji The Kanji variation of the person's address (Japan only).
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property \Paayes\PaayesObject $dob
 ...
 * @property null|\Paayes\PaayesObject $future_requirements Information about the upcoming new requirements for this person, including what information needs to be collected, and by when.
 ...
 * @property \Paayes\PaayesObject $relationship
 * @property null|\Paayes\PaayesObject $requirements Information about the requirements for this person, including what information needs to be collected, and by when.
 ...
 * @property \Paayes\PaayesObject $verification
 */
class Person extends ApiResource
{
    ...
    /**
     * @return string the API URL for this Paayes account reversal
     */
