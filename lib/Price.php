 ...
 * href="https://docs.paayes.com/docs/api#products">Products</a> help you track
 ...
 * a subscription</a>, <a
 * href="https://docs.paayes.com/docs/billing/invoices/create">create an invoice</a>,
 * and more about <a href="https://docs.paayes.com/docs/billing/prices-guide">products
 * and prices</a>.
 *
 ...
 * @property string|\Paayes\Product $product The ID of the product this price is associated with.
 * @property null|\Paayes\PaayesObject $recurring The recurring components of a price such as <code>interval</code> and <code>usage_type</code>.
 ...
 * @property null|\Paayes\PaayesObject $transform_quantity Apply a transformation to the reported usage or set quantity before computing the amount billed. Cannot be combined with <code>tiers</code>.
