...
/**
 * Paayes needs to collect certain pieces of information about each account
 ...
 * @property \Paayes\PaayesObject $supported_bank_account_currencies Currencies that can be accepted in the specific country (for transfers).
 * @property string[] $supported_payment_currencies Currencies that can be accepted in the specified country (for payments).
 * @property string[] $supported_payment_methods Payment methods available in the specified country. You may need to enable some payment methods (e.g., <a href="https://docs.paayes.com/docs/ach">ACH</a>) on your account before they appear in this list. The <code>Paayes</code> payment method refers to <a href="https://docs.paayes.com/docs/connect/destination-charges">charging through your platform</a>.
 * @property string[] $supported_transfer_countries Countries that can accept transfers from the specified country.
 * @property \Paayes\PaayesObject $verification_fields
 */
