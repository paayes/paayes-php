...
/**
 * A <code>Payout</code> object is created when you receive funds from Paayes, or
 * when you initiate a payout to either a bank account or debit card of a <a
 * href="/docs/connect/bank-debit-card-payouts">connected Paayes account</a>. You
 ...
 *
 * Related guide: <a href="https://docs.paayes.com/docs/payouts">Receiving Payouts</a>.
 *
 ...
 * @property bool $automatic Returns <code>true</code> if the payout was created by an <a href="https://docs.paayes.com/docs/payouts#payout-schedule">automated payout schedule</a>, and <code>false</code> if it was <a href="https://docs.paayes.com/docs/payouts#manual-payouts">requested manually</a>.
 * @property null|string|\Paayes\BalanceTransaction $balance_transaction ID of the balance transaction that describes the impact of this payout on your account balance.
 ...
 * @property null|string|\Paayes\BankAccount|\Paayes\Card $destination ID of the bank account or card the payout was sent to.
 * @property null|string|\Paayes\BalanceTransaction $failure_balance_transaction If the payout failed or was canceled, this will be the ID of the balance transaction that reversed the initial balance transaction, and puts the funds from the failed payout back in your balance.
 * @property null|string $failure_code Error code explaining reason for payout failure if available. See <a href="https://docs.paayes.com/docs/api#payout_failures">Types of payout failures</a> for a list of failure codes.
 ...
 * @property string $method The method used to send this payout, which can be <code>standard</code> or <code>instant</code>. <code>instant</code> is only supported for payouts to debit cards. (See <a href="https://paayes.com/blog/instant-payouts-for-marketplaces">Instant payouts for marketplaces</a> for more information.)
 * @property null|string|\Paayes\Payout $original_payout If the payout reverses another, this is the ID of the original payout.
 * @property null|string|\Paayes\Payout $reversed_by If the payout was reversed, this is the ID of the payout that reverses this payout.
...
class Payout extends ApiResource
{
     ...
     *
     * @return \Paayes\Payout the canceled payout
     */
     ...
     * @throws \Paayes\Exception\ApiErrorException if the request fails
     *
     * @return \Paayes\Payout the reversed payout
     */
