...
/**
 * You can <a href="https://docs.paayes.com/docs/issuing/cards">create physical or
 ...
 * @property string $cvc The card's CVC. For security reasons, this is only available for virtual cards, and will be omitted unless you explicitly request it with <a href="https://docs.paayes.com/api/expanding_objects">the <code>expand</code> parameter</a>. Additionally, it's only available via the <a href="https://docs.paayes.com/api/issuing/cards/retrieve">&quot;Retrieve a card&quot; endpoint</a>, not via &quot;List all cards&quot; or any other endpoint.
 ...
 * @property null|string|\Paayes\Issuing\Card $replaced_by The latest card that replaces this card, if any.
 * @property null|string|\Paayes\Issuing\Card $replacement_for The card this card replaces, if any.
 * @property null|string $replacement_reason The reason why the previous card needed to be replaced.
 * @property null|\Paayes\PaayesObject $shipping Where and how the card will be shipped.
 * @property \Paayes\PaayesObject $spending_controls
 * @property string $status Whether authorizations can be approved on this card.
 * @property string $type The type of the card.
 */
class Card extends \Paayes\ApiResource
{
     ...
     *
     * @return \Paayes\Issuing\CardDetails the card details associated with that issuing card
     */
