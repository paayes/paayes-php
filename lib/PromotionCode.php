 ...
 * @property \Paayes\Coupon $coupon A coupon contains information about a percent-off or amount-off discount you might want to apply to a customer. Coupons may be applied to <a href="https://docs.paayes.com/docs/api#invoices">invoices</a> or <a href="https://docs.paayes.com/docs/api#create_order-coupon">orders</a>. Coupons do not work with conventional one-off <a href="https://docs.paayes.com/docs/api#create_charge">charges</a>.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|string|\Paayes\Customer $customer The customer that this promotion code can be used by.
 ...
 * @property \Paayes\PaayesObject $restrictions
