 ...
 * href="https://docs.paayes.com/docs/api#retrieve_event">individual event</a> or a <a
 * href="https://docs.paayes.com/docs/api#list_events">list of events</a> from the API.
 ...
 * managed in your <a href="https://dashboard.paayes.com/account/webhooks">account
 * settings</a>, and our <a href="https://docs.paayes.com/docs/webhooks">Using
 * Webhooks</a> guide will help you get set up.
 *
 * When using <a href="https://docs.paayes.com/docs/connect">Connect</a>, you can also
 ...
 * href="https://docs.paayes.com/docs/api#retrieve_event">Retrieve Event API</a> is
 * guaranteed only for 30 days.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property string $account The connected account that originated the event.
 * @property null|string $api_version The Paayes API version used to render <code>data</code>. <em>Note: This property is populated only for events on or after October 31, 2014</em>.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property \Paayes\PaayesObject $data
 ...
 * @property null|\Paayes\PaayesObject $request Information on the API request that instigated the event.
...
class Event extends ApiResource
{
     ...
     *
     * @see https://docs.paayes.com/docs/api#event_types
     */
