 ...
 * refunded to the Paayes account from which the fee was originally collected.
 *
 * Related guide: <a
 * href="https://docs.paayes.com/docs/connect/destination-charges#refunding-app-fee">Refunding
 * Application Fees</a>.
 *
 ...
 * @property string|\Paayes\ApplicationFee $fee ID of the application fee that was refunded.
...
class ApplicationFeeRefund extends ApiResource
{
    ...
    /**
     * @return string the API URL for this Paayes refund
     */
