...
class ChargeService extends \Paayes\Service\AbstractService
{
    /**
     ...
     * will occur as if in live mode. (Paayes assumes that the charge would have
     ...
     * unique charge ID that was returned from your previous request, and Paayes will
