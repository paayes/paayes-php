...
class InvoiceService extends \Paayes\Service\AbstractService
{
    /**
    ...
    {
        return $this->requestCollection('get', '/api/v1/invoices', $params, $opts);
    }
    ...
    {
        return $this->requestCollection('get', $this->buildPath('/api/v1/invoices/%s/lines', $parentId), $params, $opts);
    }
     ...
     * @throws \Paayes\Exception\ApiErrorException if the request fails
     *
     * @return \Paayes\Invoice
     */
    public function create($params = null, $opts = null)
    {
        return $this->request('post', '/api/v1/invoices', $params, $opts);
    }
    ...
    {
        return $this->request('delete', $this->buildPath('/api/v1/invoices/%s', $id), $params, $opts);
    }

    /**
     * Paayes automatically finalizes drafts before sending and attempting payment on
    ...
    {
        return $this->request('post', $this->buildPath('/api/v1/invoices/%s/finalize', $id), $params, $opts);
    }
    ...
    {
        return $this->request('post', $this->buildPath('/api/v1/invoices/%s/mark_uncollectible', $id), $params, $opts);
    }

    /**
     * Paayes automatically creates and then attempts to collect payment on invoices
     * for customers on subscriptions according to your <a
     * href="https://dashboard.paayes.com/account/billing/automatic">subscriptions
    ...
    {
        return $this->request('post', $this->buildPath('/api/v1/invoices/%s/pay', $id), $params, $opts);
    }
    ...
    {
        return $this->request('get', $this->buildPath('/api/v1/invoices/%s', $id), $params, $opts);
    }

    /**
     * Paayes will automatically send invoices to customers according to your <a
     * href="https://dashboard.paayes.com/account/billing/automatic">subscriptions
    ...
    {
        return $this->request('post', $this->buildPath('/api/v1/invoices/%s/send', $id), $params, $opts);
    }
    ...
    {
        return $this->request('get', '/api/v1/invoices/upcoming', $params, $opts);
    }
    ...
    {
        return $this->requestCollection('get', '/api/v1/invoices/upcoming/lines', $params, $opts);
    }
     ...
     *
     * If you would like to stop the Paayes Billing engine from automatically
    ...
    {
        return $this->request('post', $this->buildPath('/api/v1/invoices/%s', $id), $params, $opts);
    }
    ...
    {
        return $this->request('post', $this->buildPath('/api/v1/invoices/%s/void', $id), $params, $opts);
    }
}
