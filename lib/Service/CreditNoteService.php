...
class CreditNoteService extends \Paayes\Service\AbstractService
{
    /**
    ...
    {
        return $this->requestCollection('get', '/api/v1/credit_notes', $params, $opts);
    }
    ...
    {
        return $this->requestCollection('get', $this->buildPath('/api/v1/credit_notes/%s/lines', $parentId), $params, $opts);
    }
     ...
     * <li>Outside of Paayes credit: record the amount that is or will be credited
     * outside of Paayes (using <code>out_of_band_amount</code>).</li> </ul>
     *
     * For post-payment credit notes the sum of the refund, credit and outside of
     * Paayes amounts must equal the credit note total.
     *
     ...
     * @throws \Paayes\Exception\ApiErrorException if the request fails
     *
     * @return \Paayes\CreditNote
     */
    public function create($params = null, $opts = null)
    {
        return $this->request('post', '/api/v1/credit_notes', $params, $opts);
    }
    ...
    {
        return $this->request('get', '/api/v1/credit_notes/preview', $params, $opts);
    }
    ...
    {
        return $this->requestCollection('get', '/api/v1/credit_notes/preview/lines', $params, $opts);
    }
    ...
    {
        return $this->request('get', $this->buildPath('/api/v1/credit_notes/%s', $id), $params, $opts);
    }
    ...
    {
        return $this->request('post', $this->buildPath('/api/v1/credit_notes/%s', $id), $params, $opts);
    }
    ...
    {
        return $this->request('post', $this->buildPath('/api/v1/credit_notes/%s/void', $id), $params, $opts);
    }
}
