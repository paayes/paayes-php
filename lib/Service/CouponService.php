...
class CouponService extends \Paayes\Service\AbstractService
{
    /**
    ...
    {
        return $this->requestCollection('get', '/api/v1/coupons', $params, $opts);
    }

    /**
     * You can create coupons easily via the <a
     * href="https://dashboard.paayes.com/coupons">coupon management</a> page of the
     * Paayes dashboard. Coupon creation is also accessible via the API if you need to
     ...
     * @throws \Paayes\Exception\ApiErrorException if the request fails
     *
     * @return \Paayes\Coupon
     */
    public function create($params = null, $opts = null)
    {
        return $this->request('post', '/api/v1/coupons', $params, $opts);
    }

    /**
     * You can delete coupons via the <a
     * href="https://dashboard.paayes.com/coupons">coupon management</a> page of the
     * Paayes dashboard. However, deleting a coupon does not affect any customers who
    ...
    {
        return $this->request('delete', $this->buildPath('/api/v1/coupons/%s', $id), $params, $opts);
    }
    ...
    {
        return $this->request('get', $this->buildPath('/api/v1/coupons/%s', $id), $params, $opts);
    }
    ...
    {
        return $this->request('post', $this->buildPath('/api/v1/coupons/%s', $id), $params, $opts);
    }
}
