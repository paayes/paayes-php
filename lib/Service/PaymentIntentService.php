...
class PaymentIntentService extends \Paayes\Service\AbstractService
{
    /**
    ...
    {
        return $this->requestCollection('get', '/api/v1/payment_intents', $params, $opts);
    }
     ...
     * @throws \Paayes\Exception\ApiErrorException if the request fails
     *
     * @return \Paayes\PaymentIntent
     */
    public function cancel($id, $params = null, $opts = null)
    {
        return $this->request('post', $this->buildPath('/api/v1/payment_intents/%s/cancel', $id), $params, $opts);
    }
    ...
    {
        return $this->request('post', $this->buildPath('/api/v1/payment_intents/%s/capture', $id), $params, $opts);
    }
     ...
     * href="/docs/Paayes-js/reference#Paayes-handle-card-payment">client SDKs</a> and
    ...
    {
        return $this->request('post', $this->buildPath('/api/v1/payment_intents/%s/confirm', $id), $params, $opts);
    }
    ...
    {
        return $this->request('post', '/api/v1/payment_intents', $params, $opts);
    }
    ...
    {
        return $this->request('get', $this->buildPath('/api/v1/payment_intents/%s', $id), $params, $opts);
    }
    ...
    {
        return $this->request('post', $this->buildPath('/api/v1/payment_intents/%s', $id), $params, $opts);
    }
}
