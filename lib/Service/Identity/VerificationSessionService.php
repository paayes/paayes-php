...
class VerificationSessionService extends \Paayes\Service\AbstractService
{
    /**
    ...
    {
        return $this->requestCollection('get', '/api/v1/identity/verification_sessions', $params, $opts);
    }
     ...
     * @throws \Paayes\Exception\ApiErrorException if the request fails
     *
     * @return \Paayes\Identity\VerificationSession
     */
    public function cancel($id, $params = null, $opts = null)
    {
        return $this->request('post', $this->buildPath('/api/v1/identity/verification_sessions/%s/cancel', $id), $params, $opts);
    }
    ...
    {
        return $this->request('post', '/api/v1/identity/verification_sessions', $params, $opts);
    }

    /**
     * Redact a VerificationSession to remove all collected information from Paayes.
     ...
     *
     * Redaction is irreversible. Redacted objects are still accessible in the Paayes
    ...
    {
        return $this->request('post', $this->buildPath('/api/v1/identity/verification_sessions/%s/redact', $id), $params, $opts);
    }
    ...
    {
        return $this->request('get', $this->buildPath('/api/v1/identity/verification_sessions/%s', $id), $params, $opts);
    }
    ...
    {
        return $this->request('post', $this->buildPath('/api/v1/identity/verification_sessions/%s', $id), $params, $opts);
    }
}
