...
class AccountService extends \Paayes\Service\AbstractService
{
    /**
    ...
    {
        return $this->requestCollection('get', '/api/v1/accounts', $params, $opts);
    }
    ...
    {
        return $this->requestCollection('get', $this->buildPath('/api/v1/accounts/%s/capabilities', $parentId), $params, $opts);
    }
    ...
    {
        return $this->requestCollection('get', $this->buildPath('/api/v1/accounts/%s/external_accounts', $parentId), $params, $opts);
    }
    ...
    {
        return $this->requestCollection('get', $this->buildPath('/api/v1/accounts/%s/persons', $parentId), $params, $opts);
    }

    /**
     * With <a href="/docs/connect">Connect</a>, you can create Paayes accounts for
     * your users. To do this, you’ll first need to <a
     * href="https://dashboard.paayes.com/account/applications/settings">register your
     * platform</a>.
     *
     * @param null|array $params
     * @param null|array|\Paayes\Util\RequestOptions $opts
     ...
     * @throws \Paayes\Exception\ApiErrorException if the request fails
     *
     * @return \Paayes\Account
     */
    public function create($params = null, $opts = null)
    {
        return $this->request('post', '/api/v1/accounts', $params, $opts);
    }
     ...
     * @throws \Paayes\Exception\ApiErrorException if the request fails
     *
     * @return \Paayes\BankAccount|\Paayes\Card
     */
    public function createExternalAccount($parentId, $params = null, $opts = null)
    {
        return $this->request('post', $this->buildPath('/api/v1/accounts/%s/external_accounts', $parentId), $params, $opts);
    }

    /**
     * Creates a single-use login link for an Express account to access their Paayes
     * dashboard.
     *
     ...
     * @throws \Paayes\Exception\ApiErrorException if the request fails
     *
     * @return \Paayes\LoginLink
     */
    public function createLoginLink($parentId, $params = null, $opts = null)
    {
        return $this->request('post', $this->buildPath('/api/v1/accounts/%s/login_links', $parentId), $params, $opts);
    }
     ...
     * @throws \Paayes\Exception\ApiErrorException if the request fails
     *
     * @return \Paayes\Person
     */
    public function createPerson($parentId, $params = null, $opts = null)
    {
        return $this->request('post', $this->buildPath('/api/v1/accounts/%s/persons', $parentId), $params, $opts);
    }
     ...
     * href="https://dashboard.paayes.com/account">account information tab in your
    ...
    {
        return $this->request('delete', $this->buildPath('/api/v1/accounts/%s', $id), $params, $opts);
    }
    ...
    {
        return $this->request('delete', $this->buildPath('/api/v1/accounts/%s/external_accounts/%s', $parentId, $id), $params, $opts);
    }
    ...
    {
        return $this->request('delete', $this->buildPath('/api/v1/accounts/%s/persons/%s', $parentId, $id), $params, $opts);
    }
    ...
    {
        return $this->request('post', $this->buildPath('/api/v1/accounts/%s/reject', $id), $params, $opts);
    }
     ...
     * @throws \Paayes\Exception\ApiErrorException if the request fails
     *
     * @return \Paayes\Capability
     */
    public function retrieveCapability($parentId, $id, $params = null, $opts = null)
    {
        return $this->request('get', $this->buildPath('/api/v1/accounts/%s/capabilities/%s', $parentId, $id), $params, $opts);
    }
    ...
    {
        return $this->request('get', $this->buildPath('/api/v1/accounts/%s/external_accounts/%s', $parentId, $id), $params, $opts);
    }
    ...
    {
        return $this->request('get', $this->buildPath('/api/v1/accounts/%s/persons/%s', $parentId, $id), $params, $opts);
    }
     ...
     * href="https://dashboard.paayes.com/account">Dashboard</a>. Refer to our <a
    ...
    {
        return $this->request('post', $this->buildPath('/api/v1/accounts/%s', $id), $params, $opts);
    }
    ...
    {
        return $this->request('post', $this->buildPath('/api/v1/accounts/%s/capabilities/%s', $parentId, $id), $params, $opts);
    }
    ...
    {
        return $this->request('post', $this->buildPath('/api/v1/accounts/%s/external_accounts/%s', $parentId, $id), $params, $opts);
    }
    ...
    {
        return $this->request('post', $this->buildPath('/api/v1/accounts/%s/persons/%s', $parentId, $id), $params, $opts);
    }
     ...
     * @param null|array $params
     * @param null|array|PaayesUtilRequestOptions $opts
     *
     * @throws \Paayes\Exception\ApiErrorException if the request fails
     *
     * @return \Paayes\Account
    ...
    {
        if (null === $id) {
            return $this->request('get', '/api/v1/account', $params, $opts);
        }

        return $this->request('get', $this->buildPath('/api/v1/accounts/%s', $id), $params, $opts);
    }
}
