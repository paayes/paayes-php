...
class SetupIntentService extends \Paayes\Service\AbstractService
{
    /**
    ...
    {
        return $this->requestCollection('get', '/api/v1/setup_intents', $params, $opts);
    }
     ...
     * @throws \Paayes\Exception\ApiErrorException if the request fails
     *
     * @return \Paayes\SetupIntent
     */
    public function cancel($id, $params = null, $opts = null)
    {
        return $this->request('post', $this->buildPath('/api/v1/setup_intents/%s/cancel', $id), $params, $opts);
    }
    ...
    {
        return $this->request('post', $this->buildPath('/api/v1/setup_intents/%s/confirm', $id), $params, $opts);
    }
    ...
    {
        return $this->request('post', '/api/v1/setup_intents', $params, $opts);
    }
    ...
    {
        return $this->request('get', $this->buildPath('/api/v1/setup_intents/%s', $id), $params, $opts);
    }
    ...
    {
        return $this->request('post', $this->buildPath('/api/v1/setup_intents/%s', $id), $params, $opts);
    }
}
