...
class SubscriptionItemService extends \Paayes\Service\AbstractService
{
    /**
    ...
    {
        return $this->requestCollection('get', '/api/v1/subscription_items', $params, $opts);
    }
    ...
    {
        return $this->requestCollection('get', $this->buildPath('/api/v1/subscription_items/%s/usage_record_summaries', $parentId), $params, $opts);
    }
     ...
     * @throws \Paayes\Exception\ApiErrorException if the request fails
     *
     * @return \Paayes\SubscriptionItem
     */
    public function create($params = null, $opts = null)
    {
        return $this->request('post', '/api/v1/subscription_items', $params, $opts);
    }
     ...
     * with a quantity.
     *
     * Usage records provide <code>quantity</code> information that Paayes uses to
     * track how much a customer is using your service. With usage information and the
     * pricing model set up by the <a
     * href="https://docs.paayes.com/docs/billing/subscriptions/metered-billing">metered
     * billing</a> plan, Paayes helps you send accurate invoices to your customers.
     *
     ...
     * there is more than one usage record with the same timestamp, Paayes adds the
     ...
     * href="https://docs.paayes.com/docs/billing/subscriptions/tiers">tiered pricing</a>
     * model.
     *
     * @param string $parentId
     * @param null|array $params
    ...
    {
        return $this->request('post', $this->buildPath('/api/v1/subscription_items/%s/usage_records', $parentId), $params, $opts);
    }
    ...
    {
        return $this->request('delete', $this->buildPath('/api/v1/subscription_items/%s', $id), $params, $opts);
    }
    ...
    {
        return $this->request('get', $this->buildPath('/api/v1/subscription_items/%s', $id), $params, $opts);
    }
    ...
    {
        return $this->request('post', $this->buildPath('/api/v1/subscription_items/%s', $id), $params, $opts);
    }
}
