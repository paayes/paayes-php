 ...
 *
 * Related guide: <a href="https://docs.paayes.com/docs/sources/cards">Card Payments
 * with Sources</a>.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property null|string|\Paayes\Account $account The account this card belongs to. This attribute will not be in the card object if the card belongs to a customer or recipient instead.
 ...
 * @property null|string $currency Three-letter <a href="https://docs.paayes.com/docs/payouts">ISO code for currency</a>. Only applicable on accounts (not customers or recipients). The card can be used as a transfer destination for funds in this currency.
 * @property null|string|\Paayes\Customer $customer The customer that this card belongs to. This attribute will not be in the card object if the card belongs to an account or recipient instead.
 * @property null|string $cvc_check If a CVC was provided, results of the check: <code>pass</code>, <code>fail</code>, <code>unavailable</code>, or <code>unchecked</code>. A result of unchecked indicates that CVC was provided but hasn't been checked yet. Checks are typically performed when attaching a card to a Customer object, or when creating a charge. For more details, see <a href="https://support.paayes.com/questions/check-if-a-card-is-valid-without-a-charge">Check if a card is valid without a charge</a>.
 ...
 * @property null|string|\Paayes\Recipient $recipient The recipient that this card belongs to. This attribute will not be in the card object if the card belongs to a customer or account instead.
...
class Card extends ApiResource
{
     ...
     *
     * @see https://docs.paayes.com/api/cards/object#card_object-cvc_check
     */
     ...
     *
     * @see https://docs.paayes.com/api/cards/object#card_object-funding
     */
     ...
     *
     * @see https://docs.paayes.com/api/cards/object#card_object-tokenization_method
     */
     ...
     *
     * @throws \Paayes\Exception\BadMethodCallException
     */
