 ...
 * They represent a customer's payment instrument, and can be used with the Paayes
 * API just like a <code>Card</code> object: once chargeable, they can be charged,
 * or can be attached to customers.
 *
 * Related guides: <a href="https://docs.paayes.com/docs/sources">Sources API</a> and <a
 * href="https://docs.paayes.com/docs/sources/customers">Sources &amp; Customers</a>.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property \Paayes\PaayesObject $ach_credit_transfer
 * @property \Paayes\PaayesObject $ach_debit
 ...
 * @property \Paayes\PaayesObject $code_verification
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|string $currency Three-letter <a href="https://docs.paayes.com/docs/currencies">ISO code for the currency</a> associated with the source. This is the currency for which the source will be chargeable once ready. Required for <code>single_use</code> sources.
 ...
 * @property \Paayes\PaayesObject $klarna
 ...
 * @property \Paayes\PaayesObject $multibanco
 * @property null|\Paayes\PaayesObject $owner Information about the owner of the payment instrument that may be used or required by particular source types.
 * @property \Paayes\PaayesObject $p24
 * @property \Paayes\PaayesObject $receiver
 * @property \Paayes\PaayesObject $redirect
 * @property \Paayes\PaayesObject $sepa_credit_transfer
 * @property \Paayes\PaayesObject $sepa_debit
 * @property \Paayes\PaayesObject $sofort
 * @property \Paayes\PaayesObject $source_order
 ...
 * @property \Paayes\PaayesObject $three_d_secure
 ...
 * @property \Paayes\PaayesObject $wechat
 */
class Source extends ApiResource
{
     ...
     *
     * @throws \Paayes\Exception\UnexpectedValueException if the source is not attached to a customer
     * @throws \Paayes\Exception\ApiErrorException if the request fails
     *
     * @return \Paayes\Source the detached source
     */
     ...
     * @throws \Paayes\Exception\ApiErrorException if the request fails
     *
     * @return \Paayes\Collection the list of source transactions
     */
     ...
     * @throws \Paayes\Exception\ApiErrorException if the request fails
     *
     * @return \Paayes\Source the verified source
     */
