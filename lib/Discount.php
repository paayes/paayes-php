 ...
 * @property \Paayes\Coupon $coupon Hash describing the coupon applied to create this discount.
 * @property string|\Paayes\Customer $customer The ID of the customer associated with this discount.
 ...
 */
class Discount extends PaayesObject
{
