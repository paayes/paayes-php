 ...
 */
class Collection extends PaayesObject implements \Countable, \IteratorAggregate
{
    ...
    /**
     * @return \Generator|PaayesObject[] A generator that can be used to
     ...
     *
     * @return null|\Paayes\PaayesObject
     */
