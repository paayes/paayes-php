 ...
 * for having Paayes tabulate your usage-based billing totals.
 *
 * Related guide: <a
 * href="https://docs.paayes.com/docs/billing/invoices/subscription#adding-upcoming-invoice-items">Subscription
 * Invoices</a>.
 *
 ...
 * @property string|\Paayes\Customer $customer The ID of the customer who will be billed when this invoice item is billed.
 ...
 * @property null|(string|\Paayes\Discount)[] $discounts The discounts which apply to the invoice item. Item discounts are applied before invoice discounts. Use <code>expand[]=discounts</code> to expand each discount.
 * @property null|string|\Paayes\Invoice $invoice The ID of the invoice this invoice item belongs to.
 ...
 * @property \Paayes\PaayesObject $period
 * @property null|\Paayes\Plan $plan If the invoice item is a proration, the plan of the subscription that the proration was computed for.
 * @property null|\Paayes\Price $price The price of the invoice item.
 ...
 * @property null|string|\Paayes\Subscription $subscription The subscription that this invoice item has been created for, if any.
 * @property string $subscription_item The subscription item that this invoice item has been created for, if any.
 * @property null|\Paayes\TaxRate[] $tax_rates The tax rates which apply to the invoice item. When set, the <code>default_tax_rates</code> on the invoice do not apply to this invoice item.
