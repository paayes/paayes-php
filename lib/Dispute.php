 ...
 * documentation.
 *
 * Related guide: <a href="https://docs.paayes.com/docs/disputes">Disputes and
 * Fraud</a>.
 *
 ...
 * @property \Paayes\BalanceTransaction[] $balance_transactions List of zero, one, or two balance transactions that show funds withdrawn and reinstated to your Paayes account as a result of this dispute.
 * @property string|\Paayes\Charge $charge ID of the charge that was disputed.
 ...
 * @property \Paayes\PaayesObject $evidence_details
 * @property bool $is_charge_refundable If true, it is still possible to refund the disputed payment. Once the payment has been fully refunded, no further funds will be withdrawn from your Paayes account as a result of this dispute.
...
class Dispute extends ApiResource
{
     ...
     *
     * @return \Paayes\Dispute the closed dispute
     */
