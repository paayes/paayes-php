 ...
 * @property \Paayes\PaayesObject[] $discounts The discounts applied to the line item.
 * @property null|\Paayes\Price $price The price used to generate the line item.
 * @property null|int $quantity The quantity of products being purchased.
 * @property \Paayes\PaayesObject[] $taxes The taxes applied to the line item.
 */
