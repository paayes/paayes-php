 ...
 * specific run parameters. Once the object is created, Paayes begins processing
 ...
 * href="https://docs.paayes.com/docs/reporting/statements/api">API Access to
 * Reports</a>.
 *
 ...
 * @property \Paayes\PaayesObject $parameters
 * @property string $report_type The ID of the <a href="https://docs.paayes.com/docs/reports/report-types">report type</a> to run, such as <code>&quot;balance.summary.1&quot;</code>.
 * @property null|\Paayes\File $result The file object representing the result of the report run (populated when <code>status=succeeded</code>).
 ...
 */
class ReportRun extends \Paayes\ApiResource
{
