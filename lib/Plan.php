 ...
 * href="https://docs.paayes.com/docs/api#prices">Prices API</a>. It replaces the Plans
 ...
 * of products. <a href="https://docs.paayes.com/docs/api#products">Products</a> help
 ...
 *
 * Related guides: <a
 * href="https://docs.paayes.com/docs/billing/subscriptions/set-up-subscription">Set up
 * a subscription</a> and more about <a
 * href="https://docs.paayes.com/docs/billing/prices-guide">products and prices</a>.
 *
 ...
 * @property null|string|\Paayes\Product $product The product whose pricing this plan determines.
 * @property \Paayes\PaayesObject[] $tiers Each element represents a pricing tier. This parameter requires <code>billing_scheme</code> to be set to <code>tiered</code>. See also the documentation for <code>billing_scheme</code>.
 ...
 * @property null|\Paayes\PaayesObject $transform_usage Apply a transformation to the reported usage or set quantity before computing the amount billed. Cannot be combined with <code>tiers</code>.
 * @property null|int $trial_period_days Default number of trial days when subscribing a customer to this plan using <a href="https://docs.paayes.com/docs/api#create_subscription-trial_from_plan"><code>trial_from_plan=true</code></a>.
