 ...
 * href="https://docs.paayes.com/docs/api#invoices">invoices</a> or <a
 * href="https://docs.paayes.com/docs/api#create_order-coupon">orders</a>. Coupons do
 * not work with conventional one-off <a
 * href="https://docs.paayes.com/docs/api#create_charge">charges</a>.
 *
 ...
 * @property \Paayes\PaayesObject $applies_to
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|string $currency If <code>amount_off</code> has been set, the three-letter <a href="https://docs.paayes.com/docs/currencies">ISO code for the currency</a> of the amount to take off.
