...
/**
 * This is an object representing a capability for a Paayes account.
 *
 * Related guide: <a
 * href="https://docs.paayes.com/docs/connect/account-capabilities">Account
 * capabilities</a>.
 *
 * @property string $id The identifier for the capability.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property string|\Paayes\Account $account The account for which the capability enables functionality.
