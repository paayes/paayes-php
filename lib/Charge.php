 ...
 * @property null|string|\Paayes\PaayesObject $application ID of the Connect application that created the charge.
 * @property null|string|\Paayes\ApplicationFee $application_fee The application fee (if any) for the charge. <a href="https://docs.paayes.com/docs/connect/direct-charges#collecting-fees">See the Connect documentation</a> for details.
 * @property null|int $application_fee_amount The amount of the application fee (if any) requested for the charge. <a href="https://docs.paayes.com/docs/connect/direct-charges#collecting-fees">See the Connect documentation</a> for details.
 * @property null|string|\Paayes\BalanceTransaction $balance_transaction ID of the balance transaction that describes the impact of this charge on your account balance (not including refunds or disputes).
 ...
 * @property null|string|\Paayes\Customer $customer ID of the customer this charge is for if one exists.
 * @property null|string $description An arbitrary string attached to the object. Often useful for displaying to users.
 * @property null|string|\Paayes\Account $destination ID of an existing, connected Paayes account to transfer funds to if <code>transfer_data</code> was specified in the charge request.
 * @property null|string|\Paayes\Dispute $dispute Details about the dispute if the charge has been disputed.
 * @property bool $disputed Whether the charge has been disputed.
 * @property null|string $failure_code Error code explaining reason for charge failure if available (see <a href="https://docs.paayes.com/docs/api#errors">the errors section</a> for a list of codes).
 * @property null|string $failure_message Message to user further explaining reason for charge failure if available.
 * @property null|\Paayes\PaayesObject $fraud_details Information on fraud assessments for the charge.
 * @property null|string|\Paayes\Invoice $invoice ID of the invoice this charge is for if one exists.
 ...
 * @property null|string|\Paayes\Account $on_behalf_of The account (if any) the charge was made on behalf of without triggering an automatic transfer. See the <a href="https://docs.paayes.com/docs/connect/charges-transfers">Connect documentation</a> for details.
 * @property null|string|\Paayes\Order $order ID of the order this charge is for if one exists.
 * @property null|\Paayes\PaayesObject $outcome Details about whether the payment was accepted, and why. See <a href="https://docs.paayes.com/docs/declines">understanding declines</a> for details.
 * @property bool $paid <code>true</code> if the charge succeeded, or was successfully authorized for later capture.
 * @property null|string|\Paayes\PaymentIntent $payment_intent ID of the PaymentIntent associated with this charge, if one exists.
 * @property null|string $payment_method ID of the payment method used in this charge.
 * @property null|\Paayes\PaayesObject $payment_method_details Details about the payment method at the time of the transaction.
 ...
 * @property \Paayes\Collection $refunds A list of refunds that have been applied to the charge.
 * @property null|string|\Paayes\Review $review ID of the review associated with this charge if one exists.
 * @property null|\Paayes\PaayesObject $shipping Shipping information for the charge.
 * @property null|\Paayes\Account|\Paayes\AlipayAccount|\Paayes\BankAccount|\Paayes\BitcoinReceiver|\Paayes\Card|\Paayes\Source $source This is a legacy field that will be removed in the future. It contains the Source, Card, or BankAccount object used for the charge. For details about the payment method used for this charge, refer to <code>payment_method</code> or <code>payment_method_details</code> instead.
 * @property null|string|\Paayes\Transfer $source_transfer The transfer ID which created this charge. Only present if the charge came from another Paayes account. <a href="https://docs.paayes.com/docs/connect/destination-charges">See the Connect documentation</a> for details.
 ...
 * @property string|\Paayes\Transfer $transfer ID of the transfer to the <code>destination</code> account (only applicable if the charge was created using the <code>destination</code> parameter).
 * @property null|\Paayes\PaayesObject $transfer_data An optional dictionary including the account to automatically transfer to as part of a destination charge. <a href="https://docs.paayes.com/docs/connect/destination-charges">See the Connect documentation</a> for details.
 * @property null|string $transfer_group A string that identifies this transaction as part of a group. See the <a href="https://docs.paayes.com/docs/connect/charges-transfers#transfer-options">Connect documentation</a> for details.
 */
class Charge extends ApiResource
{
     ...
     * These strings are applicable to the decline_code property of the \Paayes\Exception\CardException exception.
     *
     * @see https://docs.paayes.com/docs/declines/codes
     */
     ...
     *
     * @return \Paayes\Charge the captured charge
     */
