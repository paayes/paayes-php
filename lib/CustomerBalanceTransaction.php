 ...
 * href="https://docs.paayes.com/api/customers/object#customer_object-balance"><code>balance</code></a>
 ...
 * <a href="https://docs.paayes.com/api/customers/update">update customer API</a>,
 ...
 *
 * Related guide: <a
 * href="https://docs.paayes.com/docs/billing/customer/balance">Customer Balance</a> to
 * learn more.
 *
 ...
 * @property null|string|\Paayes\CreditNote $credit_note The ID of the credit note (if any) related to the transaction.
 ...
 * @property string|\Paayes\Customer $customer The ID of the customer the transaction belongs to.
 ...
 * @property null|string|\Paayes\Invoice $invoice The ID of the invoice (if any) related to the transaction.
