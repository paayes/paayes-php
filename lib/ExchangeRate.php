...
/**
 * <code>Exchange Rate</code> objects allow you to determine the rates that Paayes
 ...
 * Please refer to our <a href="https://docs.paayes.com/docs/exchange-rates">Exchange
 ...
 * @property \Paayes\PaayesObject $rates Hash where the keys are supported currencies and the values are the exchange rate at which the base id currency converts to the key currency.
 */
