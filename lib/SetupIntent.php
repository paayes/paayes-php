 ...
 * href="https://docs.paayes.com/docs/api#payment_intents">PaymentIntents</a> to drive
 * the payment flow.
 *
 ...
 * href="https://docs.paayes.com/docs/payments/intents#intent-statuses">statuses</a> as
 ...
 * run through <a
 * href="https://docs.paayes.com/docs/strong-customer-authentication">Strong Customer
 * Authentication</a> at the time of payment method collection in order to
 * streamline later <a
 * href="https://docs.paayes.com/docs/payments/setup-intents">off-session payments</a>.
 * If the SetupIntent is used with a <a
 * href="https://docs.paayes.com/docs/api#setup_intent_object-customer">Customer</a>,
 ...
 * href="https://docs.paayes.com/docs/api#payment_intent_object-setup_future_usage">setup_future_usage</a>
 ...
 *
 * Related guide: <a href="https://docs.paayes.com/docs/payments/setup-intents">Setup
 * Intents API</a>.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property null|string|\Paayes\PaayesObject $application ID of the Connect application that created the SetupIntent.
 ...
 * @property null|string|\Paayes\Customer $customer <p>ID of the Customer this SetupIntent belongs to, if one exists.</p><p>If present, the SetupIntent's payment method will be attached to the Customer on successful setup. Payment methods attached to other Customers cannot be used with this SetupIntent.</p>
 * @property null|string $description An arbitrary string attached to the object. Often useful for displaying to users.
 * @property null|\Paayes\ErrorObject $last_setup_error The error encountered in the previous SetupIntent confirmation.
 * @property null|string|\Paayes\SetupAttempt $latest_attempt The most recent SetupAttempt for this SetupIntent.
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|string|\Paayes\Mandate $mandate ID of the multi use Mandate generated by the SetupIntent.
 ...
 * @property null|\Paayes\PaayesObject $next_action If present, this property tells you what actions you need to take in order for your customer to continue payment setup.
 * @property null|string|\Paayes\Account $on_behalf_of The account (if any) for which the setup is intended.
 * @property null|string|\Paayes\PaymentMethod $payment_method ID of the payment method used with this SetupIntent.
 * @property null|\Paayes\PaayesObject $payment_method_options Payment-method-specific configuration for this SetupIntent.
 ...
 * @property null|string|\Paayes\Mandate $single_use_mandate ID of the single_use Mandate generated by the SetupIntent.
 * @property string $status <a href="https://docs.paayes.com/docs/payments/intents#intent-statuses">Status</a> of this SetupIntent, one of <code>requires_payment_method</code>, <code>requires_confirmation</code>, <code>requires_action</code>, <code>processing</code>, <code>canceled</code>, or <code>succeeded</code>.
...
class SetupIntent extends ApiResource
{
     ...
     *
     * @return \Paayes\SetupIntent the canceled setup intent
     */
     ...
     * @throws \Paayes\Exception\ApiErrorException if the request fails
     *
     * @return \Paayes\SetupIntent the confirmed setup intent
     */
