 ...
 * href="https://docs.paayes.com/docs/payments/checkout">Checkout</a>. We recommend
 ...
 * <a href="https://docs.paayes.com/api/customers">Customer</a>, and either the
 * successful <a
 * href="https://docs.paayes.com/api/payment_intents">PaymentIntent</a> or an
 * active <a href="https://docs.paayes.com/api/subscriptions">Subscription</a>.
 *
 * You can create a Checkout Session on your server and pass its ID to the client
 * to begin Checkout.
 *
 * Related guide: <a href="https://docs.paayes.com/docs/payments/checkout/api">Checkout
 * Server Quickstart</a>.
 *
 * @property string $id Unique identifier for the object. Used to pass to <code>redirectToCheckout</code> in Paayes.js.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property null|\Paayes\PaayesObject $after_expiration When set, provides configuration for actions to take if this Checkout Session expires.
 ...
 * @property null|\Paayes\PaayesObject $consent Results of <code>consent_collection</code> for this session.
 * @property null|\Paayes\PaayesObject $consent_collection When set, provides configuration for the Checkout Session to gather active consent from customers.
 ...
 * @property null|string|\Paayes\Customer $customer The ID of the customer for this Session. For Checkout Sessions in <code>payment</code> or <code>subscription</code> mode, Checkout will create a new customer object based on information provided during the payment flow unless an existing customer was provided when the Session was created.
 * @property null|\Paayes\PaayesObject $customer_details The customer details including the customer's tax exempt status and the customer's tax IDs. Only present on Sessions in <code>payment</code> or <code>subscription</code> mode.
 ...
 * @property \Paayes\Collection $line_items The line items purchased by the customer.
 ...
 * @property null|string|\Paayes\PaymentIntent $payment_intent The ID of the PaymentIntent for Checkout Sessions in <code>payment</code> mode.
 * @property null|\Paayes\PaayesObject $payment_method_options Payment-method-specific configuration for the PaymentIntent or SetupIntent of this CheckoutSession.
 ...
 * @property null|string|\Paayes\SetupIntent $setup_intent The ID of the SetupIntent for Checkout Sessions in <code>setup</code> mode.
 * @property null|\Paayes\PaayesObject $shipping Shipping information for this Checkout Session.
 * @property null|\Paayes\PaayesObject $shipping_address_collection When set, provides configuration for Checkout to collect a shipping address from a customer.
 ...
 * @property null|string|\Paayes\Subscription $subscription The ID of the subscription for Checkout Sessions in <code>subscription</code> mode.
 ...
 * @property \Paayes\PaayesObject $tax_id_collection
 * @property null|\Paayes\PaayesObject $total_details Tax and discount details for the computed total amount.
 * @property null|string $url The URL to the Checkout Session.
 */
class Session extends \Paayes\ApiResource
{
    const OBJECT_NAME = 'checkout.session';

    use \Paayes\ApiOperations\All;
    use \Paayes\ApiOperations\Create;
    use \Paayes\ApiOperations\NestedResource;
     ...
     *
     * @return \Paayes\Collection the list of items
     */
