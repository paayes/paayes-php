...
use Paayes\HttpClient\CurlClient;

/**
 * @internal
 * @covers \Paayes\ApiRequestor
 */
final class ApiRequestorTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $reflector = new \ReflectionClass(\Paayes\ApiRequestor::class);
    ...
    public function testDefaultHeaders()
    {
        ...
        Paayes::setAppInfo('MyTestApp', '1.2.34', 'https://mytestapp.example', 'partner_1234');
        $apiKey = 'sk_test_notarealkey';
        $clientInfo = ['httplib' => 'testlib 0.1.2'];

        $headers = $method->invoke(null, $apiKey, $clientInfo);

        $ua = \json_decode($headers['X-Paayes-Client-User-Agent']);
        ...
        static::assertSame(
            $headers['User-Agent'],
            'Paayes/v1 PhpBindings/' . Paayes::VERSION . ' MyTestApp/1.2.34 (https://mytestapp.example)'
        );
    ...
    public function testRaisesInvalidRequestErrorOn400()
    {
        ...
        try {
            ...
            static::assertSame('id', $e->getPaayesParam());
        } catch (\Exception $e) {
    ...
    public function testRaisesCardErrorOn402()
    {
        ...
        try {
            ...
            static::assertSame('card_declined', $e->getPaayesCode());
            static::assertSame('generic_decline', $e->getDeclineCode());
            static::assertSame('exp_month', $e->getPaayesParam());
        } catch (\Exception $e) {
            static::fail('Unexpected exception: ' . \get_class($e));
        }
    }
    ...
    public function testRaisesOAuthInvalidRequestError()
    {
        ...
        try {
            ...
            static::assertSame(400, $e->getHttpStatus());
            static::assertSame('invalid_request', $e->getPaayesCode());
    ...
    public function testRaisesOAuthInvalidClientError()
    {
        ...
        try {
            ...
            static::assertSame(401, $e->getHttpStatus());
            static::assertSame('invalid_client', $e->getPaayesCode());
    ...
    public function testRaisesOAuthInvalidGrantError()
    {
        ...
        try {
            ...
            static::assertSame(400, $e->getHttpStatus());
            static::assertSame('invalid_grant', $e->getPaayesCode());
    ...
    public function testRaisesOAuthInvalidScopeError()
    {
        ...
        try {
            ...
            static::assertSame(400, $e->getHttpStatus());
            static::assertSame('invalid_scope', $e->getPaayesCode());
    ...
    public function testRaisesOAuthUnsupportedGrantTypeError()
    {
        ...
        try {
            ...
            static::assertSame(400, $e->getHttpStatus());
            static::assertSame('unsupported_grant_type', $e->getPaayesCode());
        } catch (\Exception $e) {
            static::fail('Unexpected exception: ' . \get_class($e));
        }
    }
    ...
    public function testRaisesOAuthUnsupportedResponseTypeError()
    {
        ...
        try {
            ...
            static::assertSame(400, $e->getHttpStatus());
            static::assertSame('unsupported_response_type', $e->getPaayesCode());
    ...
    public function testHeaderPaayesVersionGlobal()
    {
        Paayes::setApiVersion('2222-22-22');
        $this->stubRequest(
            'POST',
            '/api/v1/charges',
            [],
            [
                'Paayes-Version: 2222-22-22',
            ],
            false,
            [
                'id' => 'ch_123',
    ...
    public function testHeaderPaayesVersionRequestOptions()
    {
        $this->stubRequest(
            'POST',
            '/api/v1/charges',
        ...
        Charge::create([], ['Paayes_version' => '2222-22-22']);
    }

    public function testHeaderPaayesAccountGlobal()
    {
        Paayes::setAccountId('acct_123');
        $this->stubRequest(
            'POST',
            '/api/v1/charges',
            [],
            [
                'Paayes-Account: acct_123',
            ],
            false,
            [
                'id' => 'ch_123',
    ...
    public function testHeaderPaayesAccountRequestOptions()
    {
        $this->stubRequest(
            'POST',
            '/api/v1/charges',
        ...
        Charge::create([], ['Paayes_account' => 'acct_123']);
    }
