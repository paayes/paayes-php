...
/**
 * @internal
 * @covers \Paayes\Service\BillingPortal\ConfigurationService
 */
final class ConfigurationServiceTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testCreate()
    {
        $this->expectsRequest(
            'post',
            '/api/v1/billing_portal/configurations'
        );
        ...
        static::assertInstanceOf(\Paayes\BillingPortal\Configuration::class, $resource);
    }
    ...
    public function testUpdate()
    {
        $this->expectsRequest(
            'post',
            '/api/v1/billing_portal/configurations/bpc_xyz'
        );
    ...
    public function testList()
    {
        ...
        static::assertInstanceOf(\Paayes\BillingPortal\Configuration::class, $resource->data[0]);
    }
}
