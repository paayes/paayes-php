...
final class BitcoinReceiverTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testIsListable()
    {
        ...
        static::assertSame(\Paayes\BitcoinReceiver::class, \get_class($resources->data[0]));
    }
    ...
    public function testIsRetrievable()
    {
        ...
        static::assertSame(\Paayes\BitcoinReceiver::class, \get_class($resource));
    }
}
