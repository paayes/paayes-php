...
final class CustomerTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testCanDeleteDiscount()
    {
        ...
        $this->stubRequest(
            'delete',
            '/api/v1/customers/' . $customer->id . '/discount'
        );
    ...
    public function testCanUpdateSource()
    {
        ...
        // Paayes-mock returns a Card on this method and not a bank account
        static::assertInstanceOf(\Paayes\Card::class, $resource);
    }
    ...
    public function testCanRetrieveBalanceTransaction()
    {
        $this->expectsRequest(
            'get',
            '/api/v1/customers/' . self::TEST_RESOURCE_ID . '/balance_transactions/' . self::TEST_CUSTOMER_BALANCE_TRANSACTION_ID
        );
