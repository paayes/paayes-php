 ...
 * @coversNothing
 */
final class PaayesTelemetryTest extends \PHPUnit\Framework\TestCase
{
    use TestHelper;
    ...
    public function testNoTelemetrySentIfNotEnabled()
    {
        ...
        Charge::all();
        static::assertArrayNotHasKey('X-Paayes-Client-Telemetry', $requestheaders);
    ...
    {
        Paayes::setEnableTelemetry(true);
        ...
        Charge::all();
        static::assertArrayHasKey('X-Paayes-Client-Telemetry', $requestheaders);

        $data = \json_decode($requestheaders['X-Paayes-Client-Telemetry'], true);
