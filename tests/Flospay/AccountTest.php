...
final class AccountTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testIsDeauthorizable()
    {
        ...
        $this->stubRequest(
            ...
            '/oauth/deauthorize',
            [
                'client_id' => Paayes::getClientId(),
                'Paayes_user_id' => $resource->id,
            ],
            null,
            false,
            [
    ...
    public function testPersons()
    {
        ...
        static::assertInstanceOf(\Paayes\Person::class, $persons->data[0]);
    }
    ...
    public function testSerializeNewAdditionalOwners()
    {
        $obj = Util\Util::convertToPaayesObject([
            'object' => 'account',
            'legal_entity' => PaayesObject::constructFrom([]),
        ], null);
    ...
    public function testSerializeAddAdditionalOwners()
    {
        $obj = Util\Util::convertToPaayesObject([
            ...
            'legal_entity' => [
                'additional_owners' => [
                    PaayesObject::constructFrom(['first_name' => 'Joe']),
                    PaayesObject::constructFrom(['first_name' => 'Jane']),
                ],
            ],
        ], null);
    ...
    public function testSerializePartiallyChangedAdditionalOwners()
    {
        ...
        $obj->legal_entity->additional_owners[1]->first_name = 'Paayes';
    ...
    public function testSerializePartiallyChangedIndividual()
    {
        $obj = Util\Util::convertToPaayesObject([
            'object' => 'account',
            'individual' => Util\Util::convertToPaayesObject([
                'object' => 'person',
                'first_name' => 'Jenny',
            ], null),
        ], null);
